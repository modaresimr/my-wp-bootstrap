...
function wp_bootstrap_4_scripts() {
	...
	wp_enqueue_script( 'popper-js', get_template_directory_uri() . '/assets/js/popper.js', array('jquery'), 'v1.15.0', true );
	wp_enqueue_style( 'open-iconic-bootstrap', get_template_directory_uri() . '/assets/css/open-iconic-bootstrap.css', array(), 'v4.0.0', 'all' );
	wp_enqueue_style( 'bootstrap-4', get_template_directory_uri() . '/assets/css/bootstrap.css', array(), 'v4.3.0', 'all' );
	wp_enqueue_style( 'wp-bootstrap-4-style', get_stylesheet_uri(), array(), '1.0.3', 'all' );

	wp_enqueue_script( 'bootstrap-4-js', get_template_directory_uri() . '/assets/js/bootstrap.js', array('jquery'), 'v4.3.0', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
	
	//wp_enqueue_style( 'bootstrap-select-css', get_template_directory_uri() . '/assets/css/bootstrap-select.css', array(), 'v1.13.9' );
	//wp_enqueue_script( 'bootstrap-select-js', get_template_directory_uri() . '/assets/js/bootstrap-select.js', array('jquery'), 'v1.13.9');
	

	wp_enqueue_style( 'select-2-css', get_template_directory_uri() . '/assets/css/select2.css', array(), 'v4.0.7' );
	wp_enqueue_style( 'select-2-bootstrap-css', get_template_directory_uri() . '/assets/css/select2-bootstrap.css', array(), 'v4.0.7' );
	wp_enqueue_script( 'select-2-js', get_template_directory_uri() . '/assets/js/select2.full.js', array('jquery'), 'v4.0.7');
	wp_enqueue_script( 'my-js', get_template_directory_uri() . '/assets/js/my.js', array('jquery'), 'v1.0.1');
